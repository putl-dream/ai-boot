package fun.aiboot.common.aspect;
...
public class PermissionAspect {
     ...
     * 角色权限校验
     */
    @Before("@annotation(fun.aiboot.common.annotation.RequireRole) || @within(fun.aiboot.common.annotation.RequireRole)")
     ...
     * 工具权限校验
     */
    @Before("@annotation(fun.aiboot.common.annotation.RequireTool) || @within(fun.aiboot.common.annotation.RequireTool)")
